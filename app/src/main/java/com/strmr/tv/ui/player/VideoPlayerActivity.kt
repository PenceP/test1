package com.strmr.tv.ui.player
...
import com.strmr.tv.data.repository.TraktScrobbleRepository
import com.strmr.tv.data.subtitle.SubtitleManager
import com.strmr.tv.data.subtitle.SubtitleOption
...
class VideoPlayerActivity : FragmentActivity() {
    ...
    private fun createMediaSourceFactory(): DefaultMediaSourceFactory {
        ...
        val cacheDataSourceFactory = CacheDataSource.Factory()
            .setCache(StrmrApp.getMediaCache(application))
     ...
     */
    private fun applyExternalSubtitle(subtitle: com.strmr.tv.data.subtitle.SubtitleResult) {
        val player = this.player ?: return
